...
Expand the window by moving k, and when all three characters are present, shrink it from 
the left (i) to maintain the smallest valid substring. Return the minimum length found.