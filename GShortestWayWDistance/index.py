...
class Graph:
    ...
    def shortestPathWithDistance(self, from_node, to_node):
        ...
        while myQueue:
            ...
            for neighbor, _ in sorted(self.adj_list[current]):
                if distances[neighbor] == float('inf'):   # daha önce ziyaret edilmemişse
                    distances[neighbor] = distances[current] + 1
                    parents[neighbor] = current
                    myQueue.append(neighbor)
        # BFS’de bir node’un parent’ı, ilk keşfedildiği node’dur.
        # Sonradan başka yoldan gelse bile parent güncellenmez çünkü BFS zaten en kısa yolu bulmuştur.
...
print(g.shortestPathWithDistance('A' , 'I'))
